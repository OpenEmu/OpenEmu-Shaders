...
@implementation Renderer
{
    ...
    OEFilterChain   *_filter;
    id<MTLTexture>  _offscreen;
}
...
- (void)drawInMTKView:(nonnull MTKView *)view
{
    ...
    rpd.colorAttachments[0].texture     = _offscreen;
    //rpd.colorAttachments[0].storeAction = MTLStoreActionStore;
    //rpd.depthAttachment.texture         = view.depthStencilTexture;
    //rpd.stencilAttachment.texture       = view.depthStencilTexture;
    ...
    rpd.colorAttachments[0].storeAction = MTLStoreActionStore;
    rpd.colorAttachments[0].texture     = view.currentDrawable.texture;
    if (rpd != nil)
    {
        [_filter renderWithCommandBuffer:commandBuffer renderPassDescriptor:rpd];
...
- (void)mtkView:(nonnull MTKView *)view drawableSizeWillChange:(CGSize)size
{
    ...
    // resize texture
    [self offscreenSetSize:size];
    view.window.aspectRatio = CGSizeMake(320, 240);
}

- (void)offscreenSetSize:(CGSize)size
{
    CGSize sourceSize = CGSizeMake(320, 240);
    ...
    [_filter setSourceRect:CGRectMake(0, 0, sourceSize.width, sourceSize.height) aspect:sourceSize];
    [_filter setDrawableSize:size];
    [_filter setSourceTexture:_offscreen];
}
